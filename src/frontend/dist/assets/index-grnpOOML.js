...
function useTheme() {
  const [theme, setTheme] = reactExports.useState(() => {
    const stored = localStorage.getItem("brainbyte-theme");
    return stored ?? "dark";
  });
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "header",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-5 h-5 text-white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-black tracking-tight text-gradient-primary", children: "BrainByte" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                showLeaderboardBtn && onLeaderboard && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Leaderboard" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function useLeaderboard() {
  ...
  const addEntry = reactExports.useCallback((entry) => {
    setEntries((prev) => {
      const withDate = { ...entry, date: Date.now() };
      const filtered = prev.filter(
        (e) => !(e.username === entry.username && e.theme === entry.theme)
      );
      const updated = [...filtered, withDate];
      updated.sort(
        (a, b) => b.percentage !== a.percentage ? b.percentage - a.percentage : a.timeTaken - b.timeTaken
      );
      return updated.slice(0, 10);
    });
  }, []);
  const bestPerPlayer = entries.reduce((acc, entry) => {
...
function getQuestions(theme, count) {
...
function useQuizState() {
  ...
  const navigate = reactExports.useCallback((screen) => {
    setState((s) => ({ ...s, screen }));
  }, []);
  const login = reactExports.useCallback((username) => {
    localStorage.setItem("brainbyte-username", username);
    setState((s) => ({ ...s, username, screen: "themeSelect" }));
  }, []);
  const selectCoreTheme = reactExports.useCallback((coreTheme) => {
    setState((s) => ({ ...s, coreTheme, subTheme: null }));
  }, []);
  const selectSubTheme = reactExports.useCallback((subTheme) => {
    setState((s) => ({ ...s, subTheme, screen: "quizSetup" }));
  }, []);
  const updateSetup = reactExports.useCallback(
  ...
  const submitAnswer = reactExports.useCallback((answerIndex) => {
    setState((s) => {
  ...
  const retakeQuiz = reactExports.useCallback(() => {
    setState((s) => {
      if (!s.subTheme || !s.difficulty) return s;
      const questions = getQuestions(s.subTheme, s.questionCount);
      return {
  ...
  const resetToThemeSelect = reactExports.useCallback(() => {
    setState((s) => ({
      ...s,
      coreTheme: null,
      subTheme: null,
  ...
  const getScore = () => {
    return state.answers.reduce((acc, answer, i) => {
      var _a;
      return answer === ((_a = state.questions[i]) == null ? void 0 : _a.correctIndex) ? acc + 1 : acc;
    }, 0);
  };
  const getTimeTaken = () => {
    if (!state.startTime) return 0;
    const end = state.endTime ?? Date.now();
    return Math.floor((end - state.startTime) / 1e3);
  };
  return {
    state,
    navigate,
...
function LeaderboardScreen({ entries, onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-10 sm:py-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-5 h-5 text-white" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black", children: "Leaderboard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "var(--muted-foreground)" }, children: "Top 10 Players · Best Score" })
        ] })
      ] })
    ] }),
    entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2", children: "No scores yet!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--muted-foreground)" }, children: "Complete a quiz to appear here." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "leaderboard.list", children: entries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": `leaderboard.item.${i + 1}`,
        className: "rounded-2xl p-5 flex items-center gap-4 screen-fade-in",
        style: {
          backgroundColor: i < 3 ? `${["rgba(251,191,36,0.1)", "rgba(148,163,184,0.1)", "rgba(251,146,60,0.1)"][i]}` : "var(--card)",
          border: `1px solid ${i < 3 ? ["rgba(251,191,36,0.3)", "rgba(148,163,184,0.3)", "rgba(251,146,60,0.3)"][i] : "var(--border)"}`,
          animationDelay: `${i * 0.05}s`
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl w-10 text-center flex-shrink-0", children: medals[i] ?? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: entry.username.charAt(0).toUpperCase()
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold truncate", children: entry.username }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "text-xs",
                style: { color: "var(--muted-foreground)" },
                children: [
                  themeLabels[entry.theme] ?? entry.theme,
                  " ·",
                  " ",
                  entry.difficulty
                ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  color: entry.percentage >= 90 ? "var(--primary)" : entry.percentage >= 70 ? "var(--accent)" : entry.percentage >= 50 ? "var(--chart-4)" : "var(--destructive)"
                },
                children: [
                  entry.percentage,
                  "%"
    ...
    entries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: { color: "var(--muted-foreground)" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { className: "w-3.5 h-3.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "One best score per player is shown" })
        ]
      }
    )
  ] });
...
function LoginScreen({
  ...
  const [value, setValue] = reactExports.useState(savedUsername);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-10 h-10 text-white" })
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-black mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-primary", children: "BrainByte" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "var(--muted-foreground)" }, children: "Challenge your mind. Climb the leaderboard." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "username", className: "text-sm font-medium", children: "Your Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ref: inputRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid grid-cols-3 gap-3 text-center", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl mb-1", children: f.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function QuizScreen({ state, onAnswer, onComplete }) {
  const { questions, currentIndex, timePerQuestion } = state;
  const question = questions[currentIndex];
  const [timeLeft, setTimeLeft] = reactExports.useState(timePerQuestion);
  const [selected, setSelected] = reactExports.useState(null);
  const [revealed, setRevealed] = reactExports.useState(false);
  const timerRef = reactExports.useRef(null);
  const completeCalled = reactExports.useRef(false);
  const isLastQuestion = currentIndex === questions.length - 1;
  const proceed = reactExports.useCallback(
    (answerIdx) => {
      if (revealed) return;
      setRevealed(true);
  ...
  const timerColor = timerProgress > 0.5 ? "#22C55E" : timerProgress > 0.25 ? "#F59E0B" : "#EF4444";
  const getOptionStyle = (idx) => {
    if (!revealed) {
      return {
        backgroundColor: selected === idx ? "rgba(59,130,246,0.2)" : "var(--muted)",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-8", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              style: {
                backgroundColor: revealed && idx === question.correctIndex ? "var(--primary)" : revealed && idx === selected && idx !== question.correctIndex ? "var(--destructive)" : "var(--secondary)",
                color: revealed && (idx === question.correctIndex || idx === selected) ? "white" : "var(--muted-foreground)"
              },
    ...
    revealed && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          backgroundColor: selected === question.correctIndex ? "rgba(34,197,94,0.15)" : "rgba(239,68,68,0.15)",
        ...
        children: selected === null ? "⏱️ Time's up! Moving on..." : selected === question.correctIndex ? "✅ Correct! Well done!" : `❌ Wrong! Correct: ${question.options[question.correctIndex]}`
      }
    )
  ] });
}
...
function QuizSetupScreen({
  ...
  var _a;
  const [localDiff, setLocalDiff] = reactExports.useState(
    difficulty ?? "beginner"
  );
  const [localCount, setLocalCount] = reactExports.useState(questionCount);
  reactExports.useEffect(() => {
    onUpdate(localDiff, localCount);
  }, [localDiff, localCount, onUpdate]);
  const timePerQ = ((_a = difficulties.find((d) => d.id === localDiff)) == null ? void 0 : _a.time) ?? 30;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-10 sm:py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-black", children: "Quiz Setup" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "var(--muted-foreground)" }, children: themeLabels[subTheme] })
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: difficulties.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  backgroundColor: localDiff === d.id ? `${d.color}18` : "var(--muted)",
                  boxShadow: localDiff === d.id ? `0 0 16px ${d.color}40` : "none"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
...
function ResultsScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto px-4 py-10 sm:py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-7xl mb-4 floating", children: perf.emoji }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-black mb-1", style: { color: perf.color }, children: perf.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-3xl font-black", style: { color: perf.color }, children: [
                    pct,
                    "%"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-8", children: [
          ...
          "div",
          {
            ...
            style: { backgroundColor: "var(--muted)" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl mb-1", children: stat.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "text-xs",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-bold capitalize", children: stat.value })
            ]
          },
          stat.label
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 justify-center mb-8 flex-wrap", children: state.answers.map((ans, i) => {
          var _a, _b, _c, _d, _e, _f;
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center",
              title: `Q${i + 1}: ${ans === ((_a = state.questions[i]) == null ? void 0 : _a.correctIndex) ? "Correct" : "Wrong"}`,
              style: {
                backgroundColor: ans === ((_b = state.questions[i]) == null ? void 0 : _b.correctIndex) ? "rgba(34,197,94,0.3)" : "rgba(239,68,68,0.3)",
                color: ans === ((_c = state.questions[i]) == null ? void 0 : _c.correctIndex) ? "var(--primary)" : "var(--destructive)",
                border: `1px solid ${ans === ((_d = state.questions[i]) == null ? void 0 : _d.correctIndex) ? "var(--primary)" : "var(--destructive)"}`
              },
              children: i + 1
            },
            `q-${((_f = (_e = state.questions[i]) == null ? void 0 : _e.text) == null ? void 0 : _f.slice(0, 20)) ?? i}-${i}`
          );
        }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            ...
            children: pct >= 90 ? "🏆 Top Score!" : pct >= 70 ? "🥈 Great Job!" : pct >= 50 ? "🥉 Nice Try!" : "📚 Keep Learning!"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              style: { color: "var(--muted-foreground)" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-4 h-4", style: { color: "var(--accent)" } }),
                " ",
                "View Leaderboard"
              ]
            }
...
const coreThemes = [
  {
    ...
    gradient: "linear-gradient(135deg, rgba(59,130,246,0.2) 0%, rgba(34,197,94,0.1) 100%)",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, rgba(168,85,247,0.2) 0%, rgba(59,130,246,0.1) 100%)",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg, rgba(34,197,94,0.2) 0%, rgba(245,158,11,0.1) 100%)",
...
function ThemeSelectScreen({
  coreTheme,
  onSelectCore,
  onSelectSub
}) {
  const selected = coreThemes.find((t) => t.id === coreTheme);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-10 sm:py-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            style: {
              color: coreTheme ? "var(--muted-foreground)" : "var(--foreground)"
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            style: {
              ...
              color: coreTheme ? "var(--primary-foreground)" : "var(--muted-foreground)"
            },
            children: "2"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "text-sm font-medium",
            style: {
              color: coreTheme ? "var(--foreground)" : "var(--muted-foreground)"
            },
    ...
    !coreTheme ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl sm:text-3xl font-black mb-2", children: "Choose a Category" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "var(--muted-foreground)" }, children: "Select the type of quiz you want to take" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-5", children: coreThemes.map((theme) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: theme.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold mb-2", children: theme.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl sm:text-3xl font-black", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-sm",
              style: { color: "var(--muted-foreground)" },
              children: "Pick your topic"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: selected == null ? void 0 : selected.subThemes.map((sub, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-3", children: sub.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base", children: sub.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "mt-3 text-xs",
                style: { color: "var(--muted-foreground)" },
                children: "10 Questions available"
              }
            )
          ]
        },
...
function App() {
  ...
  const [prevScreen, setPrevScreen] = reactExports.useState(quiz.state.screen);
  ...
  const renderScreen = () => {
    ...
    switch (screen) {
      case "login":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(LoginScreen, { onLogin: quiz.login, username: quiz.state.username });
      case "themeSelect":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ThemeSelectScreen,
          {
      ...
      case "leaderboard":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            entries,
            onBack: () => quiz.navigate(quiz.state.subTheme ? "results" : "themeSelect")
          }
        );
      default:
        return null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Layout,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: screenRef, className: "screen-fade-in", children: renderScreen() })
    }
  );
}
